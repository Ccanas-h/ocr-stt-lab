...
- [ ] Misma batería en el **S25** → cuánto aporta hardware más nuevo (NPU) al mismo motor.
- [ ] Misma batería en **iPhone** → es la única corrida que puede separar Vision de ML Kit.
- [ ] Medir peso del APK con y sin modelos embebidos.
- [ ] Medir el escáner de documentos de ML Kit como preprocesamiento: ¿sube el 66.7 % de
      Cencosud si la imagen llega ya recortada y enderezada?
- [ ] Probar `Script.LATIN` contra reconocimiento por bloques con `boundingBox` para los
      campos numéricos.
